...
from Multi_agent_system_demo.main import app
...
/* Hide branding — but keep the header so the sidebar toggle arrow stays usable */
...
with st.sidebar:
    ...
    thread_id = st.text_input("👤 User ID", value="aman_user",
